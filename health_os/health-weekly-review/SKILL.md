...
version: 2.0.0
description: "健康周反馈。由调度系统每周日 19:00 调用，或用户说「本周健康小结」时触发。汇总本周数据，写入本地 weekly-review.md 和 profile-updates.md，飞书发摘要。"
---
...
3. 写入本地 weekly-review.md（追加）
   路径：~/SynologyDrive/Sync/OS/Health_OS/content/YYYY/MM/weekly-review.md

4. 写入本地 profile-updates.md（只记客观信号）
   路径：~/SynologyDrive/Sync/OS/Health_OS/content/YYYY/MM/profile-updates.md
...
- 运动完成：N/7天（19:30×N，21:00×N，其他×N）
