...
Read `Personal-os/references/config.md`，取所有变量（FEISHU_BASE_TOKEN、TABLE_MONTHLY、TABLE_WEEKLY、TABLE_LOGS、MY_* 分组、USER_OPEN_ID、FIELD_IMPORTANCE）。
...
写入 `Personal-os/state/daily_snapshot_{YYYY-MM-DD}.json`。
