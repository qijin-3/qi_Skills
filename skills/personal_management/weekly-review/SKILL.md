...
2. Read `Personal-os/content/north-star.md`，取三个战略支柱名称
3. Read `Personal-os/content/about-me.md`（仅「工作风格与偏好」「时间管理」两节）
...
路径：`Personal-os/content/{YYYY}/{MM}/weekly-review.md`（不存在则先创建）
